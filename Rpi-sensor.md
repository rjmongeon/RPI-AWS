...
| 	Programming (traditional) | You need to understand the basics of procedural and object based programming. I’ve chosen Python for this project because the examples I have seen are using it so I don’t need to recreate the code, only customize it. |
